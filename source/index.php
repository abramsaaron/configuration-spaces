...
<body class="w-screen h-screen bg-white">
  <div id="navbar" class="fixed top-[10px] left-[10px] z-20 w-[calc(100vw-20px)] shadow-2xl rounded-xl h-[50px] m-0 bg-gray-500 text-black flex flex-row justify-center p-4">
    ...
    <div class="flex flex-row items-center justify-start h-full menu">
      ...
      <div class="inline-block group">
        ...
        <ul class="absolute text-white transition duration-150 ease-in-out origin-top transform scale-0 bg-gray-500 rounded-sm group-hover:scale-100 min-w-32">
          <li class="relative px-3 py-2 rounded-sm hover:bg-gray-400">
            <button class="flex items-center w-full text-left outline-none focus:outline-none">
              <span class="flex-1 pr-1">Complete graphs</span>
              <span class="mr-auto">
                <svg class="w-4 h-4 transition duration-150 ease-in-out fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                </svg>
              </span>
            </button>

            <ul class="absolute top-0 right-0 text-white transition duration-150 ease-in-out origin-top-left bg-gray-500 rounded-sm min-w-32 ">
          ...
          <li class="relative px-3 py-2 rounded-sm hover:bg-gray-400">
            <button class="flex items-center w-full text-left outline-none focus:outline-none">
              <span class="flex-1 pr-1">Complete bipartite graphs</span>
              <span class="mr-auto">
                <svg class="w-4 h-4 transition duration-150 ease-in-out fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                </svg>
          ...
          <li class="relative px-3 py-2 rounded-sm hover:bg-gray-400">
            <button class="flex items-center w-full text-left outline-none focus:outline-none">
              <span class="flex-1 pr-1">Wheel graphs</span>
              <span class="mr-auto">
                <svg class="w-4 h-4 transition duration-150 ease-in-out fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                </svg>
          ...
          <li class="relative px-3 py-2 rounded-sm hover:bg-gray-400">
            <button class="flex items-center w-full text-left outline-none focus:outline-none">
              <span class="flex-1 pr-1">Cyclic graphs</span>
              <span class="mr-auto">
                <svg class="w-4 h-4 transition duration-150 ease-in-out fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                </svg>
  ...
  <div class="fixed w-[100px]  bg-gray-500 text-white rounded-xl top-[70px] left-[10px] flex flex-col items-center">
    ...
    <i id="robotstoggle" class="p-2 m-2 text-6xl text-white bg-black rounded-full las la-bug"></i>
    <i id="texttoggle" class="p-2 m-2 text-6xl text-white bg-black rounded-full las la-bone"></i>
